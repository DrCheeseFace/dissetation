...
plt.figure(figsize=(10, 6))
plt.hist(missing_hd_age, bins=bin_edges,
         color='red', edgecolor='black', alpha=0.7)
plt.xlabel('Age', fontdict={'weight': 'bold', 'size': 22})
plt.ylabel('Frequency', fontdict={'weight': 'bold', 'size': 22})
plt.title('Distribution of Age IF Heart Disease Data is Missing',
          fontdict={'weight': 'bold', 'size': 22})
plt.xlim(min_age, max_age)
plt.grid(axis='y', linestyle='--', alpha=0.7)
