...
missing depending on the value of another variable. This is more tricky to
visualize as instead of its likelihood of being missing being dependent on the
likelihood of other variables being missing as in \textit{Joint Missingness},
we need a way to visualize the values of a variable to the.
% TODO FINISH THIS WITH A VISUALISATION
