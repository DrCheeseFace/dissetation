...
of the sci-kit learn library. Further improvements on performance particularly
on optimizing JSON string representations of custom data structures such as the
one used for representing a MissiG visualization can help reduce latency on the
client side as well as reduce round-trip-time on requests made to the MICA API.
Currently, multitouch gestures are unused within \mica; research and
implementations could be worth doing in order to further improve usability. 
